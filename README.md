...
3. It should open your Labymod addon directory; Paste the [Anti_Command_Choker.jar](https://github.com/RappyLabyAddons/AntiCommandChoker/releases/download/1.0.0/Anti_Command_Choker.jar) in there.
4. Launch your Labymod client.

### Config
- "Enabled" If the plugin is enabled or not
- "Replace the 7 with a / instead of warning you" - If this option is turned on your 7 will directly be replaced with a slash, and you will not be warned.

If you have any problems with the addon/have update ideas, feel free to
- Open an Issue [here](https://github.com/RappyLabyAddons/AntiCommandChoker/issues/new/choose)
  or
